...
The objective of this software package is to identify putative endocrine interactions in a user-friendly way, and to compare organ communication discrepincies between males and females. The goal of this work is to build upon analyzing inter-tissue endocrine interactions utilizing bioinformatics methodologies. 
...
```{r}
#Check the Dimensions of the output matricies 
